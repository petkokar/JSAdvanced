...
function solve() {
    ...
    newEditBtn.addEventListener('click', function() {
        ...
        let timeRef = event.querySelector('p:nth-of-type(1)').textContent.split(' ')[3];
        let dateRef = event.querySelector('p:nth-of-type(1)').textContent.split(' ')[1];
        let placeRef = event.querySelector('p:nth-of-type(2').textContent.split(' ')[1];
        let eventRef = event.querySelector('p:nth-of-type(3)').textContent.split(' ')[1];
        let emailRef = event.querySelector('p:nth-of-type(4)').textContent.split(' ')[1];
